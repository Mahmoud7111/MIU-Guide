...
import { getDaysUntil, isToday, formatDate, formatTime } from '@/lib/dateUtils';
        ...
        >
          {allExams.map((exam, idx) => {
            ...
            return (
              <motion.div
                key={exam.id}
                className={`${styles.timelineNode} ${isLeft ? styles.left : styles.right}`}
                variants={staggerItem}
              >
                <div data-today-marker={isExamToday} />

                {isLeft && (
                  <div className={`${styles.timelineNodeContent} ${exam.isPast ? '' : styles[urgency]}`}>
                ...
                <div className={`${styles.timelineNodeDot} ${exam.isPast ? '' : styles[urgency]}`} />
                ...
                {!isLeft && exam.isPast && (
                  <div className={styles.timelineNodeContent} style={{ opacity: 0.6 }}>
